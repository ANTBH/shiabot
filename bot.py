...
async def start_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    welcome_message = f"""
    <b>مرحبا {user_name}!
    أنا بوت كاشف أحاديث الشيعة 🔍 في قاعدة بياناتي اكثر من 26152 حديث ورواية تستطيع ايضا اضافة روايات لقاعدة بياناتي من اجل ان يستفيد اهل السنة مني </b>
